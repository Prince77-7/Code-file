          ...
          <h5 className="leading-snug">
            <span className="overflow-hidden inline-block">
              <span className="inline-block w-max">
                Hey there! I'm Waiel <br className="xs:hidden" /> — your dedicated real estate agent,{" "}
                <br className="xs:block hidden lg:hidden" /> committed to getting you the best deal <br className="xs:hidden" /> with an unbeatable 2% commission.{" "}
                <br className="lg:block hidden" />
                I handle all property <br className="xs:hidden" /> photography myself, ensuring <br className="xs:block hidden lg:hidden" />{" "}
                stunning visuals that make your listing shine.
              </span>
            </span>
            <br />
            <span className="overflow-hidden inline-block">
              <span className="inline-block w-max">
                For premium properties, I go the extra <br className="ss:hidden" /> mile by creating <br className="lg:hidden" />
                custom websites for each asset,
              </span>
            </span>{" "}
            <br />
            <span className="overflow-hidden inline-block">
              <span className="inline-block w-max">
                providing bespoke marketing <br className="lg:hidden" /> that attracts the right buyers — all at no extra cost to you.
              </span>
            </span>{" "}
            <br />
            <span className="overflow-hidden inline-block">
              <span className="inline-block w-max">Saving you money while maximizing exposure.</span>
            </span>{" "}
          </h5>
          <h5 className="leading-snug mt-6">
            <span className="overflow-hidden inline-block">
              <span className="inline-block w-max">
                My innovative approach means <br className="md:hidden" />
                you get top-tier service <br className="md:block hidden lg:hidden" /> without the traditional high fees.{" "}
                <br className="md:hidden" />
                <br className="lg:block hidden" />
                I believe in transparent, <br className="md:block hidden lg:hidden" /> efficient, and <br className="xs:hidden" />
                client-focused real estate. <br className="xs:block hidden md:hidden" /> Let's work together to achieve your property goals.{" "}
              </span>
            </span>{" "}
            <br />
            <span className="overflow-hidden inline-block">
              <span className="inline-block w-max">
                Experience the difference of a <br className="xs:hidden" /> dedicated agent who invests{" "}
                <br className="xs:block hidden lg:hidden" /> in your success, not just <br className="lg:block xs:hidden xl:hidden" /> a quick <br className="xl:block hidden" />
                sale. <br className="xs:block hidden md:hidden" /> Your satisfaction is my priority.
              </span>
            </span>{" "}
          </h5>
        </motion.div>
