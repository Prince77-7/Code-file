    ...
    <Fragment>
      ...
      <div className="fixed w-full py-4 bg-white z-[80] border-b !border-Mgrayscale_200 lg:!border-none">
        <Container className="overflow-hidden">
          ...
          >
            <Link href={"/"} className="text-Mgrayscale_900 no-underline hover:no-underline">
              <span style={{ display: 'inline-flex', alignItems: 'center', verticalAlign: 'middle' }}>
                <img 
                  src={originalUrl + "/images/Vector.svg"} 
                  alt="Logo" 
                  style={{ 
                    height: '0.8em', // Adjusted for typical asterisk size relative to text
                    width: 'auto', 
                    marginRight: '0.25em', 
                    filter: 'brightness(0)' // Attempt to make a white SVG black
                  }} 
                />
                WAIEL
              </span>
