  ...
  return (
    <Fragment>
      <Layout
        step={step}
        title="Contact Waiel"
        description="Get in touch with Waiel AL for your real estate needs."
        navbar={true}
      >
        <section>
          <Container>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-[2.5rem]">
              <div className="">
                <WrapAnimateUp step={step} direction="left">
                  ...
                  <h5 className="py-4 text__40">+1 901 666 6660</h5>
                  <h3 className="text__64 mb-[64px]">hi@waiel.co</h3>
